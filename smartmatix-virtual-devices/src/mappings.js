...
// Zwischengespeicherter Inhalt der Datei.
//
...
function load() {
  try {
    const mtimeMs = fs.statSync(FILE_PATH).mtimeMs;
    ...
    cache        = { version: SCHEMA_VERSION, devices };
...
function save(data) {
  try {
    ...
    // Zwischenspeicher mit dem eben geschriebenen Stand auffrischen
    cache        = data;
